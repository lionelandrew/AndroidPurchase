...
public class StorePurchaser extends UnityPlayerActivity{
	...
	static IabHelper.OnIabPurchaseFinishedListener mPurchaseFinishedListener = new IabHelper.OnIabPurchaseFinishedListener() {
		public void onIabPurchaseFinished(IabResult result, Purchase info) {
			...
			if (result.isFailure()){
				...
				SendErrorCodeToUnityOnPurchase(result.getMessage());
			}
			else
			{
				mHelper.consumeAsync(info, mConsumeFinishedListener);
	...
	public static void SendErrorCodeToUnityOnPurchase(String errorMessage){
		UnityPlayer.UnitySendMessage("AndroidCreditPurchaser", "OnErrorCodeFromAndroidPurchase", errorMessage);
	}
